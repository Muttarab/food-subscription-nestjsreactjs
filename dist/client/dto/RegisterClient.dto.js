...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'The user should enter a name' }),
    (0, swagger_1.ApiProperty)({ type: String, description: 'name' }),
    __metadata("design:type", String)
], RegisterClientDto.prototype, "name", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'The user should enter an email' }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'The user should enter a password' }),
    (0, class_validator_1.IsString)(),
...
//# sourceMappingURL=RegisterClient.dto.js.map